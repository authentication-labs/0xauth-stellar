...
const actions = [
  {
    ...
    bundledCodePath: path.resolve(__dirname, 'dist', 'addClaimStellar', 'index.js'),
  ...
  },
  {
    ...
    bundledCodePath: path.resolve(__dirname, 'dist', 'removeClaimStellar', 'index.js'),
  ...
  },
  {
    ...
    bundledCodePath: path.resolve(__dirname, 'dist', 'createIdentityAddKey', 'index.js'),
  ...
  },
  {
    ...
    bundledCodePath: path.resolve(__dirname, 'dist', 'addKeyStellar', 'index.js'),
    dependenciesVersion: 'v2024-08-21',
  ...
  },
  {
    ...
    bundledCodePath: path.resolve(__dirname, 'dist', 'removeKeyStellar', 'index.js'),
    dependenciesVersion: 'v2024-10-02',
