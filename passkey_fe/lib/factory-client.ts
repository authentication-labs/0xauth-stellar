...
export interface Client {
   ...
   */
  initialize: (
    { owner, wasm_hash }: { owner: string; wasm_hash: Buffer },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  link_pubkey: (
    { pub_key, identity }: { pub_key: Buffer; identity: string },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAABAAAAAAAAAAAAAAABUVycm9yAAAAAAAAAwAAAAAAAAASQWxyZWFkeUluaXRpYWxpemVkAAAAAAABAAAAAAAAABdJbnN1ZmZpY2llbnRQZXJtaXNzaW9ucwAAAAACAAAAAAAAAAxOb3RJbml0aWF0ZWQAAAAD",
